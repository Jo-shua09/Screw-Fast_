  ...
  return (
    <div className="w-full section !py-30">
      ...
      <div className="lg:w-[80%] w-full flex-wrap lg:flex-nowrap lg:gap-0 !m-auto gap-10 flex items-center justify-center !mt-20">
        ...
        <div className="bg-gray-900 rounded-xl text-white w-full lg:w-[60%] !px-16 !py-20 shadow-sm">
          ...
          <div className="!py-10 !space-x-5">
            ...
            <span className="text-2xl text-neutral-200 font-normal !normal-case">{pricingData.starterKit.billingFrequency}</span>
          </div>
        ...
        <div className="bg-gradient-to-r text-white from-orange-400 to-orange-800 rounded-xl w-full !px-16 !py-20 shadow-sm">
          <div className="!py-1 !px-4 text-2xl rounded-full text-orange-800 font-semibold bg-orange-400 !float-right">{pricingData.badge}</div>
          <div className="w-full !space-y-1">
          ...
          <div className="!py-10 !space-x-5">
            <span className="font-semibold text-8xl">
              {pricingData.professionalToolbox.price} <span className="text-xl">{pricingData.professionalToolbox.cents}</span>
            </span>
            <span className="text-2xl text-neutral-200 font-normal !normal-case">{pricingData.professionalToolbox.billingFrequency}</span>
          </div>
          <ul className="!space-y-5">
      ...
      <div className="flex items-center justify-center gap-5 w-full !mt-28">
        ...
        <a
          href="#"
          className="bg-neutral-600 rounded-xl text-[1.7rem] text-white flex items-center !normal-case font-semibold !py-4 !px-7 hover:scale-95"
        >
          {pricingData.btnText}
        </a>
      </div>
