        ...
        <div className="md:flex-[2] flex flex-col gap-y-10 w-full max-w-5xl">
          ...
          <div className="!space-y-6">
            <p className="text-4xl font-medium !normal-case italic">
              ScrewFast dramatically boosted our project efficiency. Setup was instant, and their rapid response times are phenomenal. Truly a
              game-changer in hardware and construction support!
            </p>
        ...
        <div className="relative !mx-auto h-auto w-full max-w-5xl !py-12 md:h-96">
          ...
          <div className="!mb-12 md:absolute md:left-0 md:top-0 md:!mb-0 md:h-1/2 md:w-1/2 flex flex-col items-center justify-center !p-4">
            <div className="!space-y-6">
              ...
              <p className="text-neutral-500 font-medium normal-case text-3xl">customers equipped — from DIY to major construction firms</p>
            </div>
          </div>
          ...
          <div className="!mb-12 md:absolute md:right-0 md:top-0 md:!mb-0 md:h-1/2 md:w-1/2 flex flex-col items-center justify-center !p-4">
            <div className="!space-y-6">
              ...
              <p className="text-neutral-500 font-medium normal-case text-3xl">uptick in project efficiency with ScrewFast tools and services</p>
            </div>
          </div>
          ...
          <div className="!mb-12 md:absolute md:bottom-0 md:left-0 md:!mb-0 md:h-1/2 md:w-1/2 flex flex-col items-center justify-center !p-4">
            <div className="!space-y-6 !pt-10">
              ...
              <p className="text-neutral-500 font-medium normal-case text-3xl">reduction in maintenance costs reported by long-term clients</p>
            </div>
          </div>
          ...
          <div className="md:absolute md:bottom-0 md:right-0 md:h-1/2 md:w-1/2 flex flex-col items-center justify-center !p-4">
            <div className="!space-y-6">
              ...
              <p className="text-neutral-500 font-medium normal-case text-3xl">quicker asse!mbly using innovative fastening solutions</p>
            </div>
          </div>
        </div>
