...
export const features = [
	{
		...
		imageClass:
			"lg:w-[60rem] lg:h-[55%] w-[50rem] h-[50rem] h-full object-contain rounded-2xl !shadow-[1px_1px_2px_rgba(0,0,0,0.5)]",
	},
	{
		icon: "IoAppsSharp",
		...
		imageClass:
			"lg:w-[60rem] lg:h-[80rem] w-[50rem] h-[50rem] h-full object-cover rounded-2xl !shadow-[1px_1px_2px_rgba(0,0,0,0.5)]",
	},
	{
		icon: "BsBuildings",
		...
		imageClass:
			"lg:w-[60rem] lg:h-[55%] bg-neutral-700 !p-3 w-[50rem] h-[50rem] h-full object-contain rounded-2xl !shadow-[1px_1px_2px_rgba(0,0,0,0.5)]",
	},
];
